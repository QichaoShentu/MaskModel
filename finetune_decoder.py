...
parser.add_argument("--save_name", type=str, default="W90P1MaskR256", help="")
parser.add_argument(
    "--gpu",
    type=int,
    default=0,
...
parser.add_argument("--mask_mode", type=str, default="binomial", help="")
parser.add_argument(
    "--repr_dims",
    type=int,
    default=256,
...
run_dir = "finetune_decoder/" + name_with_datetime(args.save_name)
...
# load model
print("loading...", end="")
model.load_encoder(args.model_path)
