...
class BatchSchedulerSampler(Sampler):
    ...
    def __iter__(self):
        ...
        for _ in range(0, self.len, step):
            random_sampler_iterator_id = random.randint(low=0, high=self.number_of_datasets, size=self.number_of_datasets)
            for i in random_sampler_iterator_id:
                ...
                for _ in range(self.batch_size):
                    try:
                        ...
                        cur_sample = cur_sample_index + child_dataset_start_index[i]
